...
interface MicroIconSetProps {
  className?: string;
  iconName: "sparkles" | "crown" | "eye" | "brush" | "camera" | "scissors";
  active?: boolean;
}
...
export function MicroIconSet({ className, iconName, active = false }: MicroIconSetProps) {
  ...
  switch (iconName) {
    ...
    case "scissors":
      return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={cn(baseClasses, mounted && active && "-rotate-12 scale-110")}>
