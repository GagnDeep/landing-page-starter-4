      ...
      <div className="container mx-auto px-4 relative z-10 text-center max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <MagneticButton strength={20}>
            <Link
              href="/contact"
              className="inline-flex h-14 items-center justify-center bg-background text-foreground px-8 font-sans text-sm font-semibold tracking-widest uppercase transition-transform hover:scale-105 min-w-[200px]"
            >
              {cta.buttonPrimary}
            </Link>
          </MagneticButton>
          <MagneticButton strength={20}>
            <Link
              href="/features"
              className="inline-flex h-14 items-center justify-center border border-background bg-transparent text-background px-8 font-sans text-sm font-medium tracking-widest uppercase transition-colors hover:bg-background/10 min-w-[200px]"
            >
              {cta.buttonSecondary}
            </Link>
          </MagneticButton>
