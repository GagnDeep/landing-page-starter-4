  ...
  return (
    <article className="py-24 container mx-auto px-4 max-w-3xl">
      <div className="mb-16 border-b border-border/40 pb-8">
        <h1 className="font-heading text-4xl md:text-5xl font-bold mb-4">{privacyContent.header.title}</h1>
        <p className="text-muted-foreground uppercase tracking-widest text-sm font-semibold">{privacyContent.header.lastUpdated}</p>
      </div>
