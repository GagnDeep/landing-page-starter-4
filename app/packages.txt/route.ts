...
export async function GET() {
  ...
  lines.push("")
  lines.push(
    "Three pre-built packages for Punjab homes. Tier-1 components only. PM Surya Ghar subsidy (up to ₹78,000) already applied to the listed price.",
  )
  lines.push("")
  for (const t of tiers) {
    ...
    lines.push(`Price after subsidy: ${t.price} (MRP ${t.strike})`)
