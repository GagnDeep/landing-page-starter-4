...
export default function Page() {
  return (
    <main id="main" className="min-h-screen p-8 max-w-3xl mx-auto">
      <h1 className="font-heading text-4xl mb-8 capitalize">consultation</h1>
      <p className="text-muted-foreground">Content for consultation goes here. {'{{VERIFY: need content from founder}}'}</p>
    </main>
  )
}
