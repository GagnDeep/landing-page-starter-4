...
export const blogContent = {
  seo: {
    ...
    description:
      "Insights on nail trends, curly hair care, and the art of modern beauty from the experts at Boho Salon.",
  } as SEOMetadata,
